...
class UserTable extends DataManager
{
	...
	public static function getMap()
	{
		return [
			...
			(new OneToMany('FROM_LIKES', ThankTable::class, 'USER_FROM_ID_LIST'))->configureJoinType('inner'),
			(new OneToMany('TO_LIKES', ThankTable::class, 'USER_TO_ID_LIST'))->configureJoinType('inner'),
		];
	}
}
